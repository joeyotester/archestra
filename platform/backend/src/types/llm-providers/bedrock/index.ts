...
namespace Bedrock {
  ...
  export namespace Types {
    export type ConverseHeaders = z.infer<typeof BedrockAPI.ConverseHeadersSchema>;
    export type ConverseRequest = z.infer<typeof BedrockAPI.ConverseRequestSchema>;
    export type ConverseResponse = z.infer<typeof BedrockAPI.ConverseResponseSchema>;
    export type Usage = z.infer<typeof BedrockAPI.UsageSchema>;

    export type Message = z.infer<typeof BedrockMessages.MessageSchema>;
    export type ContentBlock = z.infer<typeof BedrockMessages.ContentBlockSchema>;
    export type ResponseContentBlock = z.infer<typeof BedrockMessages.ResponseContentBlockSchema>;
