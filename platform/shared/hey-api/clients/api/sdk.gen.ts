 ...
 */
export const checkHostReachability = <ThrowOnError extends boolean = false>(options: Options<CheckHostReachabilityData, ThrowOnError>) => (options.client ?? client).get<CheckHostReachabilityResponses, unknown, ThrowOnError>({ url: '/api/reachability-check', ...options });
