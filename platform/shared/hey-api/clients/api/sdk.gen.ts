 ...
 */
export const reinstallMcpServer = <ThrowOnError extends boolean = false>(options: Options<ReinstallMcpServerData, ThrowOnError>) => (options.client ?? client).post<ReinstallMcpServerResponses, ReinstallMcpServerErrors, ThrowOnError>({ url: '/api/mcp_server/{id}/reinstall', ...options });
