 ...
 */
export const shareChatConversation = <ThrowOnError extends boolean = false>(options: Options<ShareChatConversationData, ThrowOnError>) => (options.client ?? client).post<ShareChatConversationResponses, ShareChatConversationErrors, ThrowOnError>({
